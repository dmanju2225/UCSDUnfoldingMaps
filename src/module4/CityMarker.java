...
public class CityMarker extends SimplePointMarker {
	...
	public CityMarker(Feature city) {//point feature extends feature..
		super(((PointFeature)city).getLocation(), city.getProperties());//feature does not have get location so type casting it to point feature
	}
