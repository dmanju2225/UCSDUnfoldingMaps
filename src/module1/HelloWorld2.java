...
public class HelloWorld2 extends PApplet
{
	...
	public void setup() {
		...
		//map2 = new UnfoldingMap(this, 50, 50, 350, 500, 
                //new Google.GoogleMapProvider());
		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	   map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
	    map2.zoomAndPanTo(zoomLevel, new Location(37.55f, -122.02f));
	    
		// This line makes the map interactive
		MapUtils.createDefaultEventDispatcher(this, map1);
		MapUtils.createDefaultEventDispatcher(this, map2);
		
		/*map2 = new UnfoldingMap(this, 150, 150, 100, 100, provider);
		map2.zoomAndPanTo(zoomLevel, new Location(37.55f, -122.02f));
		MapUtils.createDefaultEventDispatcher(this, map2);*/
